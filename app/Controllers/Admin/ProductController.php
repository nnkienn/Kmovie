...
class ProductController extends Auth
{
    ...
    public function store()
    {
        ...
        if ($this->input('title') == null || $this->input('thumb') == null) {
            Session::flash('error', 'Tiêu đề hoặc Video không được trống');
            return redirect('/admin/products/add');
    ...
    public function index()
    {
        ...
        return view('admin/main', [
            'title' => 'Danh Sách film - Trang ' . $page,
    ...
    public function edit(int $id = 0)
    {
        ...
        return view('admin/main', [
            'title' => 'Chỉnh sửa film: ' . $products['title'],
    ...
    public function remove()
    {
        ...
        $menu = $this->productModel->show($id);
        if ($menu == null) {
